...
public class ArrayTest {
	...
	public static void main(String[] args) {
		...
		int[] arr1 = new int[5];			//자료형[] 변수명 = new 자료형[개수];
		
		//반복문 활용
		for(int i=0; i<arr1.length;i++) {
			arr1[i] =10;
			//System.out.println(arr1[i]);			//arr은 각각의 변수이름(arr1, arr2 이렇게)
		}
		
		// 배열 생성 및 초기화 (방법1)	-- 뒤에 초기화하는 데이터 개수를 보고 생략된 숫자 유추함/ []에 숫자 넣지말기
		...
		// 길이가 7인 double형 1차원 배열 생성 하시오. (arr5)
